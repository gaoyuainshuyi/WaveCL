...
def main(config):
    ...
    save_dir = os.path.join('WaveCL/video_demo', ver_dir)
    if not os.path.exists(save_dir):
        os.makedirs(save_dir, exist_ok=True)

    output_dir = os.path.join(save_dir, "WaveCL", "visual")
    source_dir = os.path.join(save_dir, "WaveCL", "source")
    mask_dir = os.path.join(save_dir, "WaveCL", "mask")
