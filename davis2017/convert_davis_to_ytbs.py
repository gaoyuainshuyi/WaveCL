...
def read_split_set(data_root='data/refer-davis'):
...
def mv_images_to_folder(data_root='data/refer-davis', output_root='data/refer-davis'):
...
def create_meta_expressions(data_root='data/refer-davis', output_root='data/refer-davis'):
    """
...
def create_meta_annotaions(data_root='data/refer-davis', output_root='data/refer-davis'):
    """
...
if __name__ == '__main__':
    data_root = "data/refer-davis"
    output_root = "data/refer-davis"
    print("Converting refer-davis to ref-youtube-vos format....")
