...
class ReferYouTubeVOSDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = 'data/ref-youtube-vos', window_size=12,
        ...
        dataset_path = 'data/ref-youtube-vos'
        if subset_type == 'test':
    ...
    def generate_samples_metadata(self, dataset_path, subset_type, window_size, distributed):
        if subset_type == 'train':
            metadata_file_path = f'data/ref-youtube-vos/train_samples_metadata_win_size_{window_size}.json'
        else:  # validation
            metadata_file_path = f'data/ref-youtube-vos/valid_samples_metadata.json'
    ...
    def __getitem__(self, idx):
        ...
        if self.subset_type == 'train':
            with open(path.join('data/ref-youtube-vos/train', 'meta.json'), 'r') as f:
