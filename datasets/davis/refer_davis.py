...
class ReferYouTubeVOSDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = 'data/refer-davis',
    ...
    def generate_samples_metadata(self, dataset_path, subset_type, distributed):
        metadata_file_path = f'datasets/davis/valid_samples_metadata.json'
