"""
This file contains a Trainer class which handles the training and evaluation of WCL.
"""
import math
import sys
import os
    ...
    def __init__(self, config, process_id, device_id, num_processes):
        ...
        if self.is_main_process:
            ...
            if config.wandb_mode == 'online':
                wandb.init(project='RefVOS', config=config, mode=config.wandb_mode, name='WCL_VOC')
            print(config)
        else:
